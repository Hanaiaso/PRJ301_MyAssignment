...
<html>
    <head>
        ...
        <style>
            ...
            .header img {
                ...
                box-shadow: 0 2px 6px rgba(0, 0, 0, 0.15); /* Light shadow for depth */
            ...
            .company-logo {
                height: 70px; /* Adjusted size for prominence */
                margin-right: 15px;
            }
        </style>
    </head>
    <body>
        ...
        <div class="header">
            ...
            <h1>TRE COMPANY</h1>
            <a href="main"><img src="img/images.png" alt="Company Logo" class="company-logo"></a>
