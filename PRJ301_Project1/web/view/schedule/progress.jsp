...
<html>
    <head>
        ...
        <style>
            ...
            /* Menu icon styling for smaller size */
            .menu-icon {
                position: fixed;
                top: 20px;
                left: 20px;
                width: 40px; /* Smaller size for the menu icon */
                height: auto;
                cursor: pointer;
                z-index: 1100;
            }
            ...
            /* Smaller logo size in the sidebar */
            .sidebar img {
                width: 50px; /* Adjusted for a smaller logo in the sidebar */
                height: auto;
                margin-bottom: 15px;
    ...
    <body>
        <!-- Menu Icon with smaller size -->
        <img src="img/images.png" alt="Menu Icon" class="menu-icon" onclick="toggleSidebar()">

        <!-- Sidebar with a smaller company logo -->
        <div class="sidebar" id="sidebar">
            <br><br>

            <h1>Company Name</h1>
            <a href="main" onclick="toggleSidebar()">
                <img src="img/images.png" alt="Company Logo">
            </a>
