...
public class PlanListController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // Khởi tạo lớp PlanDBContext (giả sử đã có sẵn) để lấy danh sách kế hoạch
        PlanDBContext planDB = new PlanDBContext();
        ArrayList<Plan> plans = planDB.list(); // Lấy danh sách các Plan

        // Đặt danh sách Plan vào thuộc tính của request
